...
const sortPeople = (arr) => {
  // Solution code here...
  let sortedArr = arr.sort((a, b) => a.lastName < b.lastName ? -1 : 1);
...
const sortMeetingsByDay = (arr) => {
  // Solution code here...
  let daysList = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'];
  return arr.sort((a, b) => daysList.indexOf(a.dayOfWeek) - daysList.indexOf(b.dayOfWeek));
};
